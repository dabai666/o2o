...
class Order extends \YiZan\Models\Order 
{
    ...
    protected $appends = array('mapPoint', 'orderStatusStr', "isCanDelete", "isCanRate", "isCanComplain", "isCanCancel", "isCanRefund", "isCanPay", "isCanContact", "isCanConfirm", "statusFlowImage", "statusNameDate","isReceivability",'isCanRefundSeller', 'isCanAccept','isCashOnDelivery', 'isCanStartService', 'isCanFinish', 'orderStatus','paymentType','isPay','isLogistics', 'isCancel' ,'isCanCall','isCanCancelCall');
