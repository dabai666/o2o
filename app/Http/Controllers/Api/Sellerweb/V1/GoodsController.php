...
class GoodsController extends BaseController {
    ...
    public function getShopBrand(){
         $data = GoodsService::getShopBrand();
        return $this->outputData($data);
    }
    /**
     * 活动服务列表
    ...
    public function create()
    {
        ...
        (
            ...
            $this->request('originalPrice'),
            $this->request('salePrice'),
            $this->request('weight'),
            $this->request('_name1'),
            $this->request('_price1'),
            $this->request('model'),
            $this->request('goodsUnit')
        );
    ...
    {
//        var_dump($this->request['brandId']);die;
