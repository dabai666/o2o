...
class InvitationService extends BaseService {
    ...
    */
    ...
    public static function save(
        ...
        $shareExplain,$shareDescribe,$pointsNoExplain,$isAllUserPrimary,$isAllUserPercent,$isAllUserPercentSecond,$isAllUserPercentThird
    ){
        $result = array(
            'code'  => self::SUCCESS,
            'data'  => null,
        ...
        (
            ...
            'isAllUserPrimary'              => 35012,
            'isAllUserPercent'              => 35012,
            'isAllUserPercentSecond'        => 35012,
            'isAllUserPercentThird'         => 35012,
        ...
        if($sellerStatus != 1 && $sellerStatus != 0){
            $result['code'] = 35009;    // 状态不合法
            return $result;
        }
