    ...
    public static function getWapList($cityId,$platformType)
    {
        ...
        foreach ($list as $key => $val) {
            ...
            switch ($val['type']) {
                case 1 :
                    if($val['arg'] == -1){
                        $url = u('wap#Seller/cates',['index_flage'=>'index']);
                    }else{
                        $url = u('wap#Seller/index',['id'=>$val['arg'],'index_flage'=>'index']);
                    }
                    break;
                case 3 : $url = u('wap#Goods/detail',['goodsId'=>$val['arg'],'index_flage'=>'index']); break;
                case 4 : $url = u('wap#Seller/detail',['id'=>$val['arg'],'index_flage'=>'index']); break;
                case 6 : $url = u('wap#Goods/detail',['id'=>$val['arg'],'index_flage'=>'index']); break;
                case 7 : $url = u('wap#Article/detail',['id'=>$val['arg'],'index_flage'=>'index']); break;
                case 8 : $url = u('wap#UserCenter/signin',['index_flage'=>'index']); break;
                case 9 : $url = u('wap#Integral/index',['index_flage'=>'index']); break;
                case 10 : $url = u('wap#Property/index',['id'=>1,'index_flage'=>'index']); break;//Oneself/index
                case 11 : $url = u('wap#Oneself/index',['index_flage'=>'index']); break;//Property/index
                case 12 : $url = u('wap#Integral/index',['index_flage'=>'index']); break;
                case 13: $url = u('wap/Activity/secsale',['index_flage'=>'index','activityId'=>$val['arg']]);
