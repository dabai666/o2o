...
class UserAddressService extends BaseService {
     ...
     * @return array             处理结果
     */
    public static function createAddress($userId,$id,$detailAddress, $mapPoint, $provinceId, $cityId, $areaId, $name, $mobile, $doorplate, $isreg) {
        $result = array(
            'code'	=> 0,
            'data'	=> null,
            'msg'	=> null,
        ...
        $userAddress->address = $area . $detailAddress . $doorplate;
        $userAddress->detail_address = $area .  $detailAddress;
