			...
			<table>
				<columns>
                    ...
                    <column label="优惠券使用" align="left">
                        ...
                        &nbsp;&nbsp;
                        <a href="{{ u('PromotionSn/index',['promotionId'=>$list_item['id'], 'status'=>2]) }}">未使用({{$list_item['count']}})</a>
                        &nbsp;&nbsp;
                        <a href="{{ u('PromotionSn/index',['promotionId'=>$list_item['id'], 'status'=>5]) }}">已过期({{$list_item['promotionSnExpireCount']}})</a>
                        &nbsp;&nbsp;
                        <a href="{{ u('PromotionSn/index',['promotionId'=>$list_item['id'], 'status'=>4]) }}">已作废({{$list_item['deleteTotal']}})</a>
                    </column>
