...
@section('content')
    ...
    <div class="content" id=''>
        ...
        <div class="x-sjfltab x-goodstab clearfix">
                ...
                <div class="y-scroll">
                    @foreach($cate as $ckey => $item)
                        @if(count($item['goods']) > 0)
                            <p data-firstLevel="{{ $item['id'] }}" href="#tab_{{$ckey}}"  class="herfid{{$ckey}} firstLevel @if($item['id'] == Input::get('cateId')) active @else @if(Input::get('cateId') == "" && $leftsort == 0) active @endif  @endif">{{$item['name']}}</p>
                            <?php $leftsort++; ?>
                        @endif
                    @endforeach
                </div>
            ...
            <div class="tabs c-bgfff fl active">
                ...
                <hr style="border:1px solid lightgrey;"/>
                        <div id="" data-tabid = "" class="y-tab  active">
                            <div class="media-list x-sortlst f14 nobor pr y-pull pull-to-refresh-content"><!--y-pull pull-to-refresh-content-->
                                <div class="pull-to-refresh-layer none">
                                    <div class="preloader"></div>
                                    <div class="pull-to-refresh-arrow"></div>
                                </div>
                                    <div style="margin-top: 40px;" id="wdddmain">
