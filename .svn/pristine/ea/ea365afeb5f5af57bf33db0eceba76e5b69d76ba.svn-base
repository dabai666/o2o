...
class AlipaySubmit {
	 ...
	 *支付宝网关地址
	 */
	var $alipay_gateway_new_web = 'https://mapi.alipay.com/gateway.do?';
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".
            (($para_temp["service"] == "create_direct_pay_by_user" || $para_temp["service"] == "refund_fastpay_by_platform_pwd") ? $this->alipay_gateway_new_web : $this->alipay_gateway_new)
            ."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
