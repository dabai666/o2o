...
@section('show_top')
    ...
    <header class="bar bar-nav">
        ...
        <a class="button button-link button-nav pull-right pageloading clearall" href="#" data-transition='slide-out' style="margin-top: 6px;">
            <img class="share" src="{{ asset('wap/community/newclient/images/share7.png') }}"><img class="collect" src="{{ asset('wap/community/newclient/images/collect7.png') }}">
        </a>
                        ...
                        <div class="item-inner pr10">
                            ...
                            <div class="item-title-row y-qgdtxfl" style="margin-top: -10px;">
                                @if(empty($seller['activity']['special']))
                                    <div class="item-title f14">
                                        <div class="item-title f14">
                                            <span class="f15">促销价格:</span><span class="f15 c-red">￥<span id="salePirce">@if($data['norms']) {{ $data['norms'][0]['salePrice'] or $data['norms'][0]['price']}}@else{{ $data['salePrice'] or $data['price'] }}@endif </span></span>
                                            <span class="f12" style="text-decoration:line-through;">￥<span id="orightPirce">@if($data['norms']) {{ $data['norms'][0]['price'] }}@else {{ $data['originalprice'] }} @endif</span></span>
                                        </div>
                                    </div>
                                @else
                ...
                <li>
                    <div style="margin-left: 10px;margin-top: 10px;">
                        ...
                        <div style="display: flex;width: 100%;margin-top: 5px;font-size: 13px;">
                            <div style="color: #333333;">品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌：</div>
                            <div style="margin-left: 10px;"><img src="{{ $data['shopBrand']['img'] }}" style="width: 20px;height: 20px;"></div>
                            <div style="margin-left: 5px;color: #333333;">{{ $data['shopBrand']['name'] }}</div>
                        </div>
                        <div style="display: flex;width: 100%;margin-top: 5px;font-size: 13px;">
                            <div style="color: #333333;">商品重量：</div>
                            <div style="margin-left: 5px;color: #333333;">{{ number_format($data['weight'],2) }}公斤</div>
                        </div>
                        <div>
                            &nbsp;
                        </div>
...
//                $(".show_item_id_"+id+"_norms").attr("data-info",value);
            ...
            function funcMoney4(){
                ...
                $("#salePrice").html(norms_sale_price);
            }
