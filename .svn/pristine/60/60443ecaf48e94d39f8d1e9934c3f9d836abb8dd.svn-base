...
@section('right_content')
    ...
    <div class="right_box">
        <a href="{{ u('Activity/add',array('type'=>8)) }}">
            <div class="fla">
                <img src="{{ asset('images/jian.jpg') }}" style="width: 80px; height: 80px;" class="my_img">
            </div>
            <div class="fla" style="width: 195px;">
                <h2 class="title">商品促销活动</h2>
                <p style="color: #404054">该活动用于商品的促销，商品数量没有限制</p>
            </div>
        </a>
    </div>

    <div class="right_box">
        <a href="{{ u('Activity/add',array('type'=>7)) }}">
            <div class="fla">
                <img src="{{ asset('images/jian.jpg') }}" style="width: 80px; height: 80px;" class="my_img">
            </div>
            <div class="fla" style="width: 195px;">
                <h2 class="title">秒杀活动</h2>
                <p style="color: #404054">该活动用于商品的促销，商品数量限制，促销时间限制</p>
            </div>
        </a>
    </div>
