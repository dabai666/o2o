        ...
        <div class="y-qgdshoptcmain">
            ...
            <div class="y-ewmandlogo y-tccenter">
                ...
                <div class="y-dptclogo">
                    <div>
                        <img src="{{ asset('wap/community/newclient/images/y20.png')}}">
                    </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(document).on('click','.share', function () {
            ...
            if("{{$shareType}}" == "goods"){
                ...
                $(".showimges_cd").attr("src","{!! u('Seller/cancode',['id'=>$data['id'],'shareUserId'=>$loginUserId])!!}");
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            ...
            link: "{!! $share['url'] !!}&shareSellerId={{$seller['id']}}&shareUserId={{$loginUserId}}", // 分享链接
