...
class Goods extends Base { 
    ...
    public function cart(){
        return $this->hasMany('YiZan\Models\ShoppingCart',  'goods_id', 'id');
    }
    ...
    public function goodsProcessingCharges() {
        return $this->hasMany('YiZan\Models\GoodsProcessingCharges', 'goods_id', 'id');
    }

    public function shopBrand(){
        return $this->belongsTo('YiZan\Models\ShopBrand', 'id', 'brand_id');
    }
    ...
    public function orderGoods(){
        return $this->hasMany('YiZan\Models\OrderGoods','goods_id','id');
    }
}
