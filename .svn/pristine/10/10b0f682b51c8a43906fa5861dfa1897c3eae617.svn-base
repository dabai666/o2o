...
@section('show_top')
    <header class="bar bar-nav">
        ...
        <a class="button button-link button-nav pull-right open-popup" data-popup=".popup-about" href="{{ u('UserCenter/addressdetail',['SetNoCity'=>Input::get('SetNoCity'),'cartIds'=>Input::get('cartIds'),'arg'=>Input::get('arg'), 'plateId'=>Input::get('plateId'), 'postId'=>Input::get('postId'),'change'=>Input::get('change')]) }}">
            新增
        </a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(document).on("touchend",".urlte",function(){
            var url = "{!! urldecode(u('UserCenter/addressdetail' ,array('id' => 'ids','SetNoCity'=>Input::get('SetNoCity'),'arg'=>Input::get('arg'))))!!}".replace("ids", $(this).parents(".y-address").data('id'))+"&change="+isChange;
            $.router.load(url, true);
        });
