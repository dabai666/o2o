...
@section('show_top')
    <header class="bar bar-nav">
        <a href="javascript:$.href('@if($args['index_flage']) {{ u('Index/index') }} @elseif(!empty($nav_back_url) && strpos($nav_back_url, u('UserCenter/index')) === false ){{$nav_back_url}}@else{{ u('UserCenter/index') }}@endif')" class="button button-link button-nav pull-left isExternal" data-transition='slide-out'>
