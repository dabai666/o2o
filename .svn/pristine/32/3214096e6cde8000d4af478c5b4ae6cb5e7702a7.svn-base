...
class District extends Base {
	protected $visible = ['id', 'name', 'seller_id', 'address', 'province_id', 'city_id', 'house_num', 'area_num', 'house_type', 'area_id', 'map_point_str', 'province', 'city', 'area', 'departid', 'depart_tel', 'depart_mail', 'depart_street', 'depart_common', 'seller', 'province', 'city', 'area', 'isUser', 'sellerName', 'first', 'second', 'third'];
