...
<html>
<head>
	<meta http-equiv="Content-Security-Policy" content="default-src *.{{Config::get('app.domain')}} *.alicdn.com *.qq.com *.jikesoft.com *.aliyuncs.com;style-src 'self' 'unsafe-inline';img-src data: *; script-src *.qq.com *.geetest.com 'self' 'unsafe-inline' 'unsafe-eval'">
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('wap/community/newclient/css/add.css') }}?{{ TPL_VERSION }}">
    <!-- SUI基础js -->
        ...
        <div class="y-partnertc">
            <div class="y-partnercont">
                ...
                <div class="y-partnermain">
                    ...
                    <div class="p10 c-bgfff y-ptrmaintop f14">您已成为{{$is_share_alert_show_data['name']}}的第{{$is_share_alert_show_data['count']}}位邀请会员</div>
					<div class="p15">
