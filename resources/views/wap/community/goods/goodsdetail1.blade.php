                ...
                <li class="item-content" id="y-priceposition">
                    <div class="item-inner">
                        ...
                        @if($seller['serviceTimesCount'] > 0)
                            ...
                            @else
                                <div class="item-after fr">
                                    <div class="c-red f12 y-xgg pr20 pl20">选规格</div>
                                </div>
                            @endif
                        @else
                            <div class="item-after fr">
                ...
                <div class="y-gmnum clearfix">
                    @if(empty($seller['activity']['special']))
                        <span class="f14 c-red">
                            ￥<span class="money_toal" id="money_toal_{{$data['norms'][0]['id']}}">{{ number_format($data['norms'][0]['price'], 2) }}</span>
                        </span>
                    @else
                        <span class="f14 c-red">
                            ￥<span class="money_toal" id="money_toal_{{$data['norms'][0]['id']}}">{{ number_format($data['norms'][0]['salePrice'], 2) }}</span>
                        </span>
                        <del class="c-gray f12 ml5">￥<span class="delPrice">{{ number_format($data['norms'][0]['price'], 2) }}</span></del>
                    @endif
                    <span class="f14 msg_show none" style="color: red;font-size: 0.2rem !important;">抱歉：商品库存不足</span>
                    <div class="y-num fr">
                        <i data-id="{{$data['norms'][0]['id']}}" data-price="{{ number_format($data['norms'][0]['price'],2) }}" class="icon iconfont c-gray fl subtract_norms none">&#xe621;</i>
                        ...
                        <i class="icon iconfont c-red fl add_norms" data-id="{{$data['norms'][0]['id']}}"  data-price="{{ round($data['norms'][0]['price'], 2) }}" data-salePrice="{{ round($data['norms'][0]['salePrice'], 2) }}">&#xe61e;</i>
                    </div>
                    @if(!empty($seller['activity']['special']))
                        <div class="y-specialprice f12 ml0"><a href="">{{ $seller['activity']['special']['sale']}}折特价</a></div>
                    @endif
