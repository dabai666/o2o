<ul class="y-xcoupon mt10">
    @foreach($list as $val)
        <li class="clearfix f12" id="li-{{ $val['id'] }}">
            <div class="y-xcouponleft tc" onclick="$.href('{{ u('Order/order',['proId'=>$val['id'],'cartIds'=>$args['cartIds'],'addressId'=>$args['addressId'],'appTime'=>$args['appTime']]) }}')">
            ...
            @endif
            <div class="y-xcouponright" onclick="$.href('{{ u('Order/order',['proId'=>$val['id'],'cartIds'=>$args['cartIds'],'addressId'=>$args['addressId'],'appTime'=>$args['appTime']]) }}')">
