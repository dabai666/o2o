...
<header class="bar bar-nav">
    <a class="button button-link button-nav pull-left external pageloading" data-popup=".popup-about" href="{{ u('Order/order',['addressId'=>$args['addressId'],'cartIds'=>$args['cartIds'],'appTime'=>$args['appTime']]) }}" data-transition='slide-out'>
        <span class="icon iconfont">&#xe600;</span>返回
    </a>
    <a class="button button-link button-nav pull-right open-popup pageloading" data-popup=".popup-about" href="{{ u('Order/order',['cartIds'=>$args['cartIds'],'addressId'=>$args['addressId'], 'cancel'=>1,'appTime'=>$args['appTime']]) }}">
        取消选择
    </a>
