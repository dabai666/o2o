                ...
                <li>
                    ...
                    <div class="c-bgfff y-tag">
                        <div class="c-orange f12">
                            @if($seller_data['storeType'] == 0) 周边店 @else 全国店 @endif<img src="{{ asset('wap/community/newclient/images/y15.png')}}" class="va-1 ml2" width="12">
            ...
            <ul>
                <li>
                    <div class="item-content">
                        <div class="item-inner">
							@foreach($seller_data['stimes'] as $key => $value)
                            <div class="item-title-row">
                                <div class="item-title f14">
                                    <i class="icon iconfont c-gray fl">&#xe639;</i>
                                    <span class="x-storer db">配送时间：{{$value}}</span>
                                </div>
                            </div>
							@endforeach
                        </div>
                ...
                <li>
                    <div class="item-content">
                        <div class="item-inner">
                            <div class="item-title-row">
                                <div class="item-title f14">
                                    <a href="{{ u('Seller/authenticate',['id' => $seller_data['id']]) }}">
                                        <i class="icon iconfont c-gray fl f18">&#xe676;</i>
                                        <span class="x-storer db">商家营业资质证书</span>
                                    </a>
                                </div>
                            </div>
                        </div>
