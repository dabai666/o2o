...
@section('show_top')
    <header class="bar bar-nav">
        <a class="button button-link button-nav pull-left external" href="@if($args['index_flage']) javascript:$.href('{{ u('Index/index') }}'); @else javascript:$.href('{{ u('Index/index') }}'); @endif" data-transition='slide-out'>
...
@section('css')
    <style>
        .x-sjfl.buttons-tab .button{top: 0;}
        .x-sjfltab .buttons-tab,.x-sjfltab .tabs{height: 100%;overflow-x: hidden;overflow-y: scroll;}
        .x-sjfltab .x-sortlst.list-block{max-height: none;}
