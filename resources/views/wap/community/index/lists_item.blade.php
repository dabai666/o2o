        ...
        <a href="{{$url}}" class="item-link item-content pageloading" data-no-cache="true">
            ...
            <div class="item-inner">
                <div class="item-title-row f16">
                    <div class="item-title c-black @if(!$item['isBussiness'])y-w80  @endif" style="white-space: normal;">
                        <p>{{ $item['name'] }}
                    ...
                    @else
                        <div class="item-after rest f12" style="color: #E73E27;border: 1px solid #E73E27;height: .9rem;line-height: .9rem;padding: 0 .2rem;border-radius: .2rem;">营业中</div>
                    @endif
                </div>
            ...
            @if(!empty($item['activity']['new']))
                <li>
                    <p class="f12 c-gray">
                        ...
                        新用户在线支付立减{{ number_format($item['activity']['new']['cutMoney'], 2) }}元
                    </p>
                </li>
                @endif
                        <!-- 未展开 -->
            ...
            <div class="item-inner">
                <div class="item-title-row f16">
                    ...
                    @if(!$item['isBussiness'])
                        <div class="item-after rest f12">休息中</div>
                    @else
                        <div class="item-after rest f12" style="background: #E73E27;color:#fff;border: 1px solid #E73E27;height: .9rem;line-height: .9rem;padding: 0 .2rem;border-radius: .2rem;">营业中</div>
                    @endif
                </div>
                <div class="item-title-row f12 c-gray mt5 mb5">
                    <div class="item-title">
