                        ...
                        <li style="display: flex;display:-webkit-flex;justify-content: space-between;align-items: center;" class="flex justify-content align-item" data-type="{{ $v['type'] }}" data-url="@if(!strstr($v['url'],'http://')) {{ 'http://'.$v['url'] }} @else {!! $v['url'] !!} @endif ">
                            <div>
                                <a href="{{ $v['url'] }}" external>
                                    <p class="colorange" id="colorange" style="color:@if($v['type'] == 1) #089ce3 @elseif($v['type'] == 2) #fe9200 @elseif($v['type'] == 3) #9bbb2a @else #ee7457 @endif;">{{ $v['name'] }}</p>
                        ...
                        @foreach($adv as $k => $v)
                            <div style="background: #fff;">
                                ...
                                <dl style="display: flex;width: 100%;">
                                    <dl style="width: 33.333%;text-align: center;border-right:1px solid #f3f3f3;">
                                        <a href=" {{ $v['url2'] }}" external>
											<dd><img src="{{ $v['image2'] }}" style="width:80px;height:80px;"> </dd>
                                    ...
                                    <dl style="width: 33.333%;text-align: center;border-right:1px solid #f3f3f3;">
                                        <a href=" {{ $v['url3'] }}" external>
											<dd><img src="{{ $v['image3'] }}" style="width:80px;height:80px;"></dd>
                                            <strong><dt>{{ $v['title3'] }}</dt></strong>
                                            <dt style="color: {{ $v['instruction3Bg'] }};">{{ $v['instruction3'] }}</dt>
                                        </a>
                                    </dl>
                                    <dl style="width: 33.333%;text-align: center;">
                                        <a href=" {{ $v['url4'] }}" external>
											<dd><img src="{{ $v['image4'] }}" style="width:80px;height:80px;"></dd>
...
@section($js)
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#indexBrandSwiper").swiper({"pagination":".swiper-pagination-adv", "autoplay":2500});
            //回到顶部
