    ...
    <div class="content y-sharelinkcont" id=''>
       <div class="y-sharelinkbox" style="background: url('{{$invitation['inviteLogo']}}') 50% 50% no-repeat;background-size:100% 100%">
            <div class="y-sharelinktop">
                <img src="{{$weixinUserDsy['headimgurl'] or asset('wap/community/newclient/images/y20.png')}}">
                <span class="ml10 mr10">{{$weixinUserDsy['nickname']}}</span><span>正在邀请您注册 {{$weixinUserDsy['sitename']}}</span>
            </div>
            <div class="y-sharelinkbtm">
				...
				<div style="text-align:center;">
					<a href="javascript:$.loginWeixin();" style="display:block;margin-bottom:10px;"><img src="/images/wechatreg.png" width="55%" /></a>
					<a href="javascript:$.href('{{u('User/reg',['isGuide'=>1])}}');"><img src="/images/phonereg.png" width="55%" /></a>
				</div>
            </div>
        </div>
