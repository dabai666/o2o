        ...
        @else
            ...
            <div class="card y-shopcart y-shopcart{{$citem['id']}}" data-sellerid="{{$citem['id']}}">
                <div class="card-header">
                    <div class="w100">
                        <i class="icon iconfont y-checkbox mr5 c-red @if($citem['canService'] == 1 && $isnoCheck) active @endif vat" data-canservice="{{$citem['canService']}}" data-isnocheck={{$isnoCheck}} data-price="{{$citem['price']}}" data-type="all" @if($citem['serviceTimesCount'] < 1) checked="true" @else  @endif data-sellerid="{{$citem['id']}}" data-processingprice="{{$citem['processingPrice']}}">&#xe612;</i>
                        <span class="c-black f14 vat">
                            ...
                            <a href="#" @if($citem['storeType'] == 1) onclick='$.href("{{u('Seller/detail', ['id'=>$citem['id']])}}")' @else onclick='$.href("{{u('Goods/index', ['id'=>$citem['id'],'type'=>$citem['type'],'urltype'=>$citem['type']])}}")'  @endif >
								@if($citem['serviceTimesCount'] < 1) （商家休息中） @elseif(!$citem['canService']) <span style="color:red;">（不在服务范围）</span> @endif{{$citem['name']}} 
                            </a>
                        </span>
                    </div>
                </div>
                            ...
                            <li class="y-ddcontent on" data-itemid="{{$gitem['id']}}">
                                <a href="#" class="item-link item-content">
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-title-row">
                                            <div class="item-title f14 c-red">
                                                <div class="item-title f12 c-gray">
                                                    ...
                                                    @else
                                                        ￥<span class="y-price c-red">{{number_format($gitem['price'] * ($gitem['sale']/10), 2)}}</span>
                                                    @endif
                                                </div>
                                                @if($gitem['processid'])
                                                    <div class="item-title f12 c-gray">加工:&nbsp;{{$gitem['processingName']}}
                                                        ￥<span class="y-price">{{number_format($gitem['processingPrice'], 2)}}</span>
                                                    </div>
                                                @endif
                                                <!--@if( $gitem['sale'] == 10 )
                                                    ￥<span class="y-price">{{number_format($gitem['price'], 2)}}</span>
                                            ...
                                            <div class="item-after">
                                                ...
                                                <input style="width: 30px" name="gitem" type="text" value="{{$gitem['num']}}" data-sellerid="{{$citem['id']}}" data-servicetime="{{$gitem['serviceTime']}}" data-itemid="{{$gitem['id']}}" @if($cancheck) checked="true" @else checked="false" @endif data-goodsid="{{$gitem['goodsId']}}" data-normsid="{{$gitem['normsId']}}" data-price="{{$gitem['price']}}" data-sale="{{$gitem['sale']}}" data-type="{{$gitem['type']}}" data-processingprice="{{$gitem['processingPrice']}}" data-processid="{{$gitem['processid'] or 0}}" class="tc pl0 fl" readonly="readonly">
                                        ...
                                        <!--@if($gitem['processid'])
                                            <div class="item-title f12 c-gray">加工:{{$gitem['processingName']}}</div>
                                            <div class="item-title f14 c-red">
                                                ￥<span class="y-price">{{number_format($gitem['processingPrice'], 2)}}</span>
                                            </div>
                                        @endif
