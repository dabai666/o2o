        ...
        @section('content')
            <form action="javascript:;" id="goods-form">
                    ...
                    <div class="list-block">
                        <ul>
                            ...
                            <li>
                                ...
                                <a @if($data == "") onclick="$.showData1()" @else @if($data['systemGoodsId'] ==  0 || $data['systemGoodsId'] ==  "" ) onclick="JumpURL('{!! u('Seller/getShopBrand',['nav_back_url'=>$nav_back_url]) !!}','{{$css}}',2)" @else  onclick="$.showSystemMsg()"  @endif @endif>
                                    <div class="item-content">
                                        <div class="item-inner">
                ...
                <span class="fr">
                    ...
                    <div id="yz_goods_extend" class="list-block add-b @if($data) @if($data['norms'])add-block @endif @endif show_norms @if($showData['norms'])add-block @endif">
                        @if($data)
                            @if($data['norms'])
                                @foreach( $data['norms'] as $k=> $v)
                                    <div  id="del{{$v['id']}}" >
                                        <div class="delete-but" onclick ="$.deletebut2({{$v['id']}})" style="margin-top:42px;">
                                        ...
                                        <ul class="goods-editer-b s-goods-editer-b">
                                            ...
                                            <!--<li>
                                                <div class="item-content">
                                                    <div class="item-inner">
                                                        <div class="item-title label">促&nbsp;销&nbsp;价&nbsp;:</div>
                                                        <div class="item-input">
                                                            <input type="text" class="f14" placeholder="请输入金额（元）"  name="norms[{{$k}}][sale_price]" id="sale_price" value="{{$v['salePrice']}}">
                                                        </div>
                                                        <span class="unit">元</span>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="item-content">
                                                    <div class="item-inner">
                                                        ...
                                                        <div class="item-input">
                                                            <input type="text" class="f14" placeholder="请输入重量（公斤）" name="norms[{{$k}}][weight]" id="weight" value="{{$v['weight']}}">
                                                        </div>
                                    ...
                                    <!--<li>
                                        <div class="item-content">
                                            <div class="item-inner">
                                                <div class="item-title label">促 &nbsp;销&nbsp;价&nbsp;:</div>
                                                <div class="item-input">
                                                    <input type="text" class="f14" placeholder="请输入金额（元）"  name="sale_price" id="sale_price" value="{{$data['salePrice']}}">
                                                </div>
                                                <span class="unit">元</span>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="item-content">
                                            <div class="item-inner">
                                                <div class="item-title label">重&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量:</div>
                                                <div class="item-input">
                                                    <input type="text" class="f14" placeholder="请输入重量（公斤）" name="weight" id="weight" value="{{$data['weight']}}">
                                                </div>
                                                <span class="unit">公斤</span>
                                            </div>
                                        </div>
                        ...
                        @else
                            @if($showData['norms'])
                                @foreach( $showData['norms'] as $k=> $v)
                                    <div  id="del{{$k + 200}}" >
                                        <div class="delete-but" onclick ="$.deletebut2({{$k + 200}})">
                                            <i class="icon iconfont right-ico">&#xe619;</i>
                                        </div>
                                        <ul class="goods-editer-b s-goods-editer-b">
                                            <li>
                                            ...
                                            <!--<li>
                                                <div class="item-content">
                                                    <div class="item-inner">
                                                        <div class="item-title label">促&nbsp;销&nbsp;价&nbsp;:</div>
                                                        <div class="item-input">
                                                            <input type="text" class="f14" placeholder="请输入金额（元）"  name="norms[{{$k + 200}}][sale_price]" id="sale_price" value="{{$v['sale_price']}}">
                                                        </div>
                                                        <span class="unit">元</span>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="item-content">
                                                    <div class="item-inner">
                                                        <div class="item-title label">重&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量:</div>
                                                        <div class="item-input">
                                                            <input type="text" class="f14" placeholder="请输入重量（公斤）" name="norms[{{$k + 200}}][weight]" id="weight" value="{{$v['weight']}}">
                                                        </div>
                                                        <span class="unit">公斤</span>
                                                    </div>
                                                </div>
                                    ...
                                    <!--<li>
                                        <div class="item-content">
                                            <div class="item-inner">
                                                <div class="item-title label">促&nbsp;销&nbsp;价&nbsp;:</div>
                                                <div class="item-input">
                                                    <input type="text" class="f14" placeholder="请输入金额（元）"  name="sale_price" id="sale_price" value="{{$showData['sale_price']}}s-->
                                    <li style="display:none;">
                                        <div class="item-content">
                                            <div class="item-inner">
                                                <div class="item-title label">加&nbsp;工&nbsp;费&nbsp;:</div>
                                                <div class="item-input">
                                                    <input type="text" class="f14" placeholder="请输入金额（元）"  name="process_money" id="process_money" value="{{$showData['processMoney']}}">
                                                </div>
                                                <span class="unit">元</span>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="item-content">
                                            <div class="item-inner">
                                                <div class="item-title label">重&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量:</div>
                                                <div class="item-input">
                                                    <input type="text" class="f14" placeholder="请输入重量（公斤）" name="weight" id="weight" value="{{$showData['weight']}}">
                                                </div>
                                                <span class="unit">公斤</span>
                                            </div>
                                        </div>
