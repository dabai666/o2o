...
<div class="list-block" style="">
    <ul style="height: 200px;overflow-y: auto;" id="ul_li_ul_li">
        @foreach($list as $k => $v)
        <li onclick="JumpURL('{!! $nav_back_url !!}&brandId={{$v['id']}}&brandName={{$v['name']}}','#getShopBrand',1)">
            <a>
...
<script>
    ...
    $("#ul_li_ul_li").css('height',(parseInt($(window).height()) - parseInt($(".bar-nav").height())+'px'));
</script>
@stop
