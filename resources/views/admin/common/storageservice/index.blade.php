...
@section('right_content')
	...
	<yz:list>
		...
		<btns>
			<linkbtn label="添加仓储公司" url="{{ u('StorageService/create') }}"></linkbtn>
			<linkbtn label="删除" type="destroy"></linkbtn>
			<span style="color:#828282;">(仓储公司未占用时才能进行删除)</span>
		</btns>
		<table checkbox="1">
			<columns>
				<column code="id" label="编号"></column>
				<column code="name" label="仓储公司名称" align="left" style="font-weight:bold" css="name"></column>
				<column code="url" label="仓储公司外链" align="left" style="font-weight:bold" css="name"></column>
				<actions>
