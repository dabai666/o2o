...
@section('right_content')
    ...
    <yz:form id="yz_form" action="update">
        ...
        <div id="flage2" class="">
            <div>
                ...
                <fitem type="script">
                    <script type="text/javascript">
                        jQuery(function($){
                            if("{{$data['type1']}}"==13 || "{{$data['type1']}}"==3 || "{{$data['type1']}}"==4 || "{{$data['type1']}}"==6){//促销商品
                                var flage = false;
                            }else{
                                var flage = true;
                            }
            ...
            <div>
				...
				<yz:fitem name="instruction2" label="第一广告说明">
					<yz:editor name="instruction2" value="{{$data['instruction2']}}"></yz:editor>
				</yz:fitem>
				...
				<yz:fitem name="sign2" label="标记"></yz:fitem>
				<yz:fitem name="mark2" label="记号"></yz:fitem>
				<yz:fitem name="remarks2" label="备注">
					<yz:editor name="remarks2" value="{{$data['remarks2']}}"></yz:editor>
				</yz:fitem>
                ...
                <fitem type="script">
                    <script type="text/javascript">
                        jQuery(function($){
                            if("{{$data['type2']}}"==13 || "{{$data['type2']}}"==3 || "{{$data['type2']}}"==4 || "{{$data['type2']}}"==6){//促销商品
                                var flage = false;
                            }else{
                                var flage = true;
                            }
            ...
            <div>
				...
				<yz:fitem name="instruction3" label="第二广告说明">
					<yz:editor name="instruction3" value="{{$data['instruction3']}}"></yz:editor>
				</yz:fitem>
                <yz:fitem name="instruction3Bg" label="第二广告说明字体颜色" tip="例：#ffffff">
                    <yz:Color name="instruction3Bg" val="{{$data['instruction3Bg']}}"></yz:Color>
                </yz:fitem>
				<yz:fitem name="sign3" label="标记"></yz:fitem>
				<yz:fitem name="mark3" label="记号"></yz:fitem>
				<yz:fitem name="remarks3" label="备注">
					<yz:editor name="remarks3" value="{{$data['remarks3']}}"></yz:editor>
				</yz:fitem>
                ...
                <fitem type="script">
                    <script type="text/javascript">
                        jQuery(function($){
                            if("{{$data['type3']}}"==13 || "{{$data['type3']}}"==3 || "{{$data['type3']}}"==4 || "{{$data['type3']}}"==6){//促销商品
                                var flage = false;
                            }else{
                                var flage = true;
                            }
                            ...
                            $("select[name=type3]").change(function() {
                                ...
                                if(type == 1){
                                    ...
                                    $("#activityId3-form-item").hide();
                                    if(flage){
                                        window.open("{!! u('Service/index') !!}");                                    }else{
                                        flage = true;
                                    }
                                }else if(type == 4){
                                    $('#sellerCate3-form-item').hide();
            ...
            <div>
				...
				<yz:fitem name="instruction4" label="第三广告说明">
					<yz:editor name="instruction4" value="{{$data['instruction4']}}"></yz:editor>
				</yz:fitem>
                <yz:fitem name="instruction4Bg" label="第三广告说明字体颜色" tip="例：#ffffff">
                    <yz:Color name="instruction4Bg" val="{{$data['instruction4Bg']}}"></yz:Color>
                </yz:fitem>
				<yz:fitem name="sign4" label="标记"></yz:fitem>
				<yz:fitem name="mark4" label="记号"></yz:fitem>
				<yz:fitem name="remarks4" label="备注">
					<yz:editor name="remarks4" value="{{$data['remarks4']}}"></yz:editor>
				</yz:fitem>
                ...
                <fitem type="script">
                    <script type="text/javascript">
                        jQuery(function($){
                            if("{{$data['type4']}}"==13 || "{{$data['type4']}}"==3 || "{{$data['type4']}}"==4 || "{{$data['type4']}}"==6){//促销商品
                                var flage = false;
                            }else{
                                var flage = true;
                            }
        ...
        <div id="flage3">
			...
			<div style="display: flex;width: 100%;">
                <yz:fitem name="img8" label="第九品牌展示位图片" type="image"></yz:fitem>
                <yz:fitem name="brandId8" label="链接到品牌页">
                    <yz:select name="brandId8" css="type" options="$shopBrand" textfield="name" valuefield="id" selected="$data['brandId8']"></yz:select>
                </yz:fitem>
            </div>
			<div style="display: flex;width: 100%;">
                <yz:fitem name="img9" label="第十品牌展示位图片" type="image"></yz:fitem>
                <yz:fitem name="brandId9" label="链接到品牌页">
                    <yz:select name="brandId9" css="type" options="$shopBrand" textfield="name" valuefield="id" selected="$data['brandId9']"></yz:select>
                </yz:fitem>
            </div>
			<div style="display: flex;width: 100%;">
                <yz:fitem name="img10" label="第十一品牌展示位图片" type="image"></yz:fitem>
                <yz:fitem name="brandId10" label="链接到品牌页">
                    <yz:select name="brandId10" css="type" options="$shopBrand" textfield="name" valuefield="id" selected="$data['brandId10']"></yz:select>
                </yz:fitem>
            </div>
			<div style="display: flex;width: 100%;">
                <yz:fitem name="img11" label="第十二品牌展示位图片" type="image"></yz:fitem>
                <yz:fitem name="brandId11" label="链接到品牌页">
                    <yz:select name="brandId11" css="type" options="$shopBrand" textfield="name" valuefield="id" selected="$data['brandId11']"></yz:select>
                </yz:fitem>
            </div>
        </div>
    </yz:form>
