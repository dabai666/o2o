	...
	@yizan_begin
		<yz:form id="yz_form" action="serviceSave"> 
			...
			<div id="price-form-item" class="u-fitem clearfix ">
	            ...
	            <div class="f-boxr">
	                <input type="text" name="price" id="price" class="u-ipttext" value="0.00"  onKeyUp="amount(this)" onBlur="overFormat(this)">
	            </div>
	        </div>
			...
			<div id="duration-form-item" class="u-fitem clearfix ">
	            ...
	            <div class="f-boxr">
	                <input type="text" name="duration" id="duration" class="u-ipttext" value="" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
	            </div>
	        </div>
