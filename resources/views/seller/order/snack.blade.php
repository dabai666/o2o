	...
	<table>
		...
		@foreach($data['OrderGoods'] as $goods)
			<tr>
				<td width="40%">
					<p class="tc f14">
						@if($goods['goods']['autoType'] == 1)
							<img src="../images/secsale-icon.png" width="15px" height="15px" style="vertical-align: middle;margin-top: -2px;" />
						@elseif($goods['goods']['autoType'] == 2)
							<img src="../images/seckill-icon.png" width="15px" height="15px" style="vertical-align: middle;margin-top: -2px;" />
						@endif
