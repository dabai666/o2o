...
@section('content')
		<div class="m-zjgltbg">
			<div class="p10">						
                ...
                @if($data['orderType'] == 1)
                    @if($data['isCanCall'] && $data['seller']['sendType'] == 2 && $data['sellerFee'] >= $system_send_staff_fee)
        					...
        					<table>
								...
								<tr>
        						    <td style="padding-left:10px">
                                        ...
                                        @endif
	        						    @if( $data['status'] < ORDER_STATUS_FINISH_STAFF && $data['status'] != ORDER_STATUS_CALL_SYSTEM_SEND && $data['status'] != ORDER_STATUS_GET_SYSTEM_SEND && $data['status'] != ORDER_STATUS_SYSTEM_SEND)
