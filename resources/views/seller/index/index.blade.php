    ...
    <div class="m-ydtt" style="margin: 0;padding-top: 0;min-width:1050px;">
        ...
        <div class="u-ydct clearfix f14">
            ...
            <div class="clearfix cq-amount">
                <span class="fl ml10">账户余额 <span class="f24 useraccount" style="color:#b40001;"></span> 元</span>
...
$(function () {
    ...
    $.post("{{ u('Index/getAccount') }}",{id:1},function(result) {
        $('.useraccount').html(result.money);
    })
});
