						...
						<yz:form id="yz_form" action="updatebasic">
							...
							@else
				                ...
				                <yz:fitem label="配送服务" name="sendType">
				                    <yz:radio name="sendType" options="1,2" texts="配送托管,平台众包" checked="$data['sendType']" default="1"></yz:radio>
				                </yz:fitem> -->
								<yz:fitem label="消费方式">
									<yz:checkbox name="sendWay." options="1,3" texts="送货上门,到店自提" checked="$sendWay"></yz:checkbox>
					  			</yz:fitem>
								<yz:fitem label="配送服务" name="sendType">
				                    <yz:radio name="sendType" options="2" texts="平台众包" checked="$data['sendType']" default="2"></yz:radio>
				                </yz:fitem>
					  			<yz:fitem label="服务方式">
...
@endif
	@if($data)
		<script type="text/javascript">
			$("#provinceId-form-item").addClass("none");
