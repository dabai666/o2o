					...
					<div class="m-yhk m-ghkh" style="width:939px;">
						...
						<table pager="no">
							<row>
								...
								<tr style="@if($list['mapPointStr']) display: none; @endif">
									<php>
						...
						<table pager="no">
							<row>
								...
								@endif
								<tr >
									<td width="100px;" style="text-align:center">卫生许可证</td>
									<td>
										<a href="{{ $list['authenticate']['hygieneImg'] }}">
											<img src="{{ $list['authenticate']['hygieneImg'] }}" style="max-width:200px"/>
										</a>
									</td>
								</tr>
							</row>
