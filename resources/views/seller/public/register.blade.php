                ...
                <form action="">
                    ...
                    <fieldset>
                        ...
                        <div class="u-zciptct clearfix mb15">
                            ...
                            <div class="u-zciptct u-zciptct2 clearfix mb15 seller_info storeType0" id="hide456465">
                                <label class="f-tt fl "><span class="type "></span>详细地址:</label>
                                <div style="margin-left:-5px" class="f ">
                                    <input name="address" id="map-address-1" placeholder="　请输入商家的详细地址" class="u-ipttext" value="" type="text">
                                </div>
                            </div>
                            <!--<div class="u-zciptct u-zciptct2 clearfix mb15 seller_info storeType0" id="hide456465">
                                <label class="f-tt fl "><span class="type "></span>服务范围:</label>
                                <div class="fr none" style="margin-top: -46px; margin-left:105px">
