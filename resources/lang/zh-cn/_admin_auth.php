    ...
    "order" => [
        ...
        'controllers' => [
            ...
            'SaleStatistics' => [
                'name' => '销售统计',
                'icon' => 'bar-chart',
                'url'  => 'SaleStatistics/index',
                'actions' => [
                    'index' => ['name' => '销售统计', 'show_menu' => 1],
                ]
            ],
            'OrderConfig' => [
                'name' => '参数配置',
        ...
        'controllers' => [
            ...
            'Activity' => [
                ...
                'actions' => [
                    ...
                    'create' 	=> ['name' => '添加营销类型'],
                    'add' 	    => ['name' => '添加营销'],
					'save_sale_activity'  => ['name' => '保存营销'],
					'save_seckill_activity'  => ['name' => '保存秒杀活动'],
                    'edit' 		=> ['name' => '查看营销'],
                    'destroy' 	=> ['name' => '删除营销'],
                    'addSeller' => ['name' => '添加商家'],
            ...
            'user' => [
                ...
                'controllers' => [
					...
					'UserTag' => [
                        ...
                        'url'  => 'UserTag/index',
                        'actions' => [
                            'index' 	=> ['name' => '会员标签' ,'expand' => ['search'], 'show_menu' => 1],
                            'create' 	=> ['name' => '添加会员标签'],
                            'edit' 	    => ['name' => '编辑会员标签'],
                            'save' 	    => ['name' => '保存会员标签'],
                            'destroy' 	=> ['name' => '删除会员标签'],
        ...
        'nodes'=> [
            'Statistics' => [
                ...
                'controllers' => [
                    ...
                    'ClassifyBusinessStatistics' => [
                        'name' => '平台分类统计',
                        'icon' => 'order',
                        'url' => 'ClassifyBusinessStatistics/index',
                        'actions' => [
                            'index'  =>  ['name' => '统计列表','show_menu' => 1],
                            'detail' => ['name' => '查看明细'],
                            'export' => ['name' => '导出列表'],
                    ...
                    'ClassifySeckillStatistics' => [
                        'name' => '秒杀商品统计',
                        'icon' => 'order',
                        'url' => 'ClassifySeckillStatistics/index',
                        'actions' => [
                            'index'  =>  ['name' => '统计列表','show_menu' => 1],
                            /*'detail' => ['name' => '查看明细'],
                            'export' => ['name' => '导出列表'],*/
