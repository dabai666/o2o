...
return [
 /**
    ...
    */
    ...
    'api_url' => [
        'buyer' => 'http://api.test.com/buyer/v1/',
        'system' => 'http://api.test.com/system/v1/',
        'seller' => 'http://api.test.com/sellerweb/v1/',
        'staff' => 'http://api.test.com/staff/v1/',
        'proxy' => 'http://api.test.com/proxy/v1/',
    ],
    ...
    'image_config' => [
           ...
           'oss' => [
                ...
                'access_id'		=> 'LTAI1kMvM11dt4sx',
                'access_key'	=> 'xpHFpdWLkMGHFfXQKFXxgYw7wShveG',
                'bucket' 		=> 'test',
                'url' 			=> 'https://image.test.com/',
                'callback'		=> 'http://admin.test.com/Resource/callback',
            ],
        'server' =>[
                'upload_url'	=> 'http://resource.test.com/image/upload', //上传地址
                'remove_url'	=> 'http://resource.test.com/image/remove', //删除地址
                'token'			=> 'yn2CisXgPjf8',//授权TOKEN
                'url'			=> 'http://resource.test.com/upload/',//图片访问路径
